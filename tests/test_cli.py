...
EXPECTED = {"demo", "run", "stats", "event", "live", "status", "backtest", "metrics", "validate", "simulate", "calibrate", "markets", "edge", "estimate", "sweep", "history", "compare-news", "reaction", "doctor", "flow", "exit-lab", "edge-bank", "autotune", "portfolio-sim", "matrix", "dia", "false-signals", "repair", "diagnose", "propagation", "tournament"}
