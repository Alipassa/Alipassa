...
REM  o robo sai no fim do ciclo e este .bat sobe de novo em 30s com o market_ai_engine_v6.py da pasta.
...
python market_ai_engine_v6.py --log-file logs\live.log live --markets %MERCADOS% --source mt5 --mode paper --send --interval 60
